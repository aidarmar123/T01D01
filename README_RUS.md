...
>Необходимо сохранить у себя весь код, пока он не исчез

Я что то слышал про Вилки
...
_**== Получен Quest 1. Создайте форк с помощью GitHub и клонируйте репозиторий на локальный терминал с помощью клиента терминала git. ==**_
